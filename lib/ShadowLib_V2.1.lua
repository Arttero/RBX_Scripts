...
/ ___) )( \/ _\(    \/  \/ )( \  (  ) (  |  _ \  / )( (___ \
\___ ) __ (    \) D (  O ) /\ /  / (_/\)( ) _ (  \ \/ // __/
(____|_)(_|_/\_(____/\__/(_/\_)  \____(__|____/   \__/(____).1
...
if not _G.Settings then
	_G.Settings = {
		...
		['Intro'] = false,
		['Keybind'] = 'G',
		['IntroFade'] = {Color3.fromRGB(0, 43, 254), Color3.fromRGB(38, 74, 255), Color3.fromRGB(78, 108, 255)},
		['Icon'] = 5230440166
	}
end
...
if _G.Settings['Intro'] == true then
	...
	Pieces.BackgroundColor3 = _G.Settings['IntroFade'][1]
	...
	Pieces_2.BackgroundColor3 = _G.Settings['IntroFade'][2]
	Pieces_2.Rotation = 0
	
	Pieces_3 = Pieces:Clone()
	Pieces_3.Parent = Background
	Pieces_3.BackgroundColor3 = _G.Settings['IntroFade'][3]
...
Icon.Image = "http://www.roblox.com/asset/?id="..tostring(_G.Settings['Icon'])
